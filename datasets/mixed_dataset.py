...
class MixedDataset(torch.utils.data.Dataset):
    def __init__(self, options, **kwargs):
        self.dataset_list = ['3dpw']
        self.dataset_dict = {'3dpw': 0}
        # self.dataset_list = ['h36m', 'lsp-orig', 'mpii', 'lspet', 'coco', 'mpi-inf-3dhp', '3dpw']
        # self.dataset_dict = {'h36m': 0, 'lsp-orig': 1, 'mpii': 2, 'lspet': 3, 'coco': 4, 'mpi-inf-3dhp': 5, '3dpw': 6}
