...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--checkpoint_steps', type=int, default=4000, help='Checkpoint saving frequency')
        ...
        train.add_argument('--keypoint_loss_weight', default=8., type=float, help='Weight of 2D and 3D keypoint loss') 
