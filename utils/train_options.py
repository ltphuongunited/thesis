...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--summary_steps', type=int, default=200, help='Summary saving frequency')
        train.add_argument('--test_steps', type=int, default=1000, help='Testing frequency during training')
        train.add_argument('--checkpoint_steps', type=int, default=15000, help='Checkpoint saving frequency')
        ...
        train.add_argument('--num_smplify_iters', default=20, type=int, help='Number of SMPLify iterations') 
