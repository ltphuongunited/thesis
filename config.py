...
H36M_ROOT = 'datasets/all/h36m_new/images'
...
DATASET_FILES = [ {'h36m-p1': join(DATASET_NPZ_PATH, 'h36m_valid_protocol1_newpath.npz'),
                  ...
                  #  '3dpw': join(DATASET_NPZ_PATH, '3dpw_valid.npz'),
                  },
